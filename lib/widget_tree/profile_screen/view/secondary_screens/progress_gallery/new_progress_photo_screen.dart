...
class _ProgressPhotoScreenState extends State<ProgressPhotoScreen> {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              _buildProgressListTiles(context)
            ],
          ),
        ),
      ),
  ...
  Widget _buildProgressListTiles(BuildContext context) {
    return Column(
      children: [
        ListTile(
        ...
        _buildListTile(
          ...
          onPress: () async {
            ...
            setState(
              () {
                weight =
                    picker.pickerValue != "None" ? picker.pickerValue : null;
              },
            );
          },
        ),
        _buildListTile(
          ...
          onPress: () async {
            ...
            setState(
              () {
                bust = picker.pickerValue != "None" ? picker.pickerValue : null;
              },
            );
          },
        ),
        _buildListTile(
          ...
          onPress: () async {
            ...
            setState(
              () {
                bmi = picker.pickerValue != "None" ? picker.pickerValue : null;
              },
            );
          },
        ),
        ...
        _buildListTile(
          ...
          onPress: () async {
            ...
            setState(
              () {
                hip = picker.pickerValue != "None" ? picker.pickerValue : null;
              },
            );
          },
        ),
    ...
    return PlatformTextButton(
      ...
      onPressed: saving
          ...
          : () async {
              ...
              await widget.firebaseUser.addProgressPhoto(
                context: context,
                file: widget.file,
                weight: weight,
                bust: bust,
